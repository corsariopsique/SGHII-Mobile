...
class _KitDescription extends StatelessWidget {
  const _KitDescription({
    required this.id,
  ...
  String disponibilidad(int estado){
    if(estado == 0){
      return 'Disponible';
    }else if(estado == 1){
...
class CustomKitItem extends StatelessWidget {
  const CustomKitItem({
    super.key,
